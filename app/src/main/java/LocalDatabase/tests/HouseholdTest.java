...
public class HouseholdTest extends AndroidTestCase {
    ...
    public void testPost() {
        Household subject = new Household();

        subject.name = "carrot";

        long id = subject.post();
        assertTrue(id >=0 );
        Log.d("HouseholdTest : testPost", "created_at = " + subject.created_at);
        assertNotNull(subject.created_at);
        assertFalse(subject.created_at.isEmpty());
        Log.d("HouseholdTest : testPost", "updated_at = " + subject.updated_at);
        ...
        subject = null;
        subject = Household.load(Household.class, id);
        ...
        Log.d("HouseholdTest : testPost", "created_at2 = " + subject.created_at);
        assertNotNull(subject.created_at);
        assertFalse(subject.created_at.isEmpty());
        Log.d("HouseholdTest : testPost", "updated_at2 = " + subject.updated_at);
        assertNotNull(subject.updated_at);
        assertFalse(subject.updated_at.isEmpty());
