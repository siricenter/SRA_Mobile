...
public class HttpThreadRunner implements Runnable {
    ...
    /*public ThreadRunner(Handler handler, SoftReference<HashMap<String,String>> softData, String address, Updateable caller) {
    ...
    public Thread startThread(HashMap<String, Object>returnedData, String URLAddress, Updateable caller) {
        Log.d("ThreadRunner", "Creating handler on current thread");
        this.handler = new Handler();
        Log.d("ThreadRunner", "Loading soft references");
        this.softData = new SoftReference(returnedData);
        this.softAddress = new SoftReference(URLAddress);
        ...
        // tell the caller that we have finished on this thread by calling update
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    ((Updateable)softCaller.get()).update();
                }
            });
